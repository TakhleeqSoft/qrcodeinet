                    ...
                    <tr>
                        ...
                        <td>
                            @if (auth()->user()->user_type == App\Models\User::USER_TYPE_ADMIN)
                                {{ Form::open(['route' => ['restaurant.plans.destroy', ['plan' => $plan->plan_id]], 'autocomplete' => 'off', 'class' => 'data-confirm', 'data-confirm-message' => __('system.plans.are_you_sure', ['name' => $plan->title]), 'data-confirm-title' => __('system.crud.delete'), 'id' => 'delete-form_' . $plan->id, 'method' => 'delete']) }}
                            @endif
